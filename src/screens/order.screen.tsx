...
export function OrderScreen() {
  ...
  const { modal: modalSupport, setVisible: setVisibleModalSupport } =
    useModalSupport();
    ...
    <>
              ...
              <Row justify={"space-around"}>
                <Col span={10}>
                  <Button
                    ...
                    onClick={() => setModalStateHandler(name, false)}
                  >
                    No
                  </Button>
                </Col>
      ...
      <Row>
        <Typography.Paragraph>
          ...
          <span
            className={"font-bold"}
            style={{ color: textColorByStatus[status] }}
          >
            {status}
          </span>
        </Typography.Paragraph>
      ...
      {comment && (<>
        ...
        <Row style={{ marginBottom: 25 }}>
          ...
          {customerOrCourierInfo?.name && (
            <Typography.Paragraph style={{ display: "block", width: "100%", marginBottom: 5 }}>
              Name: {customerOrCourierInfo?.name}
            </Typography.Paragraph>
          )}
          <a
            style={{ display: "block", width: "100%" }}
            href={`tel:${customerOrCourierInfo?.phone}`}
          >
            Phone:{" "}
            <span
              className={"font-bold"}
      ...
      <Row
        ...
        >
          {/* <Col span={16}> */}
            <Typography.Title level={3}>Order price</Typography.Title>
          {/* </Col> */}
          {/* <Col span={8}> */}
            <Typography.Title
              level={2}
    ...
    <>
      <Row>
        <Typography.Title style={{ marginBottom: 0 }} level={5}>
          {address?.substr(0, address?.length - 5)}
        </Typography.Title>
        <Row>
